...
namespace dbe.FoundationLibrary.Core.Util
{
    ...
    {
        #region    静态字段 start
        private static readonly string[] ColorValues_56 = new string[] {
        ...
        private static readonly string[] ColorValues_1024 = new string[]{
        ...
        /// <summary>
		/// 10种不同<see cref="Color"/>
		/// </summary>
		public static readonly Color[] Colors_10 = new Color[]
        {
            Color.Red,
            Color.Blue,
            Color.Green,
        ...
        /// 56种不同颜色
        /// </summary>
        public static Color[] Colors_56 = new Color[56];

        /// <summary>
        /// 1024种不同颜色
        /// </summary>
        public static Color[] Colors_1024 = new Color[1024];
        #endregion 静态字段 end
        ...
        public static Color NextColor
        {
            get
            {
                ...
                if (colorIndex < Colors_10.Length)
                    return Colors_10[NextColorIndex];
                else if (Colors_10.Length <= colorIndex && colorIndex < Colors_56.Length)
                    return Colors_56[NextColorIndex];
                else if (Colors_56.Length <= colorIndex && colorIndex < Colors_1024.Length)
                    return Colors_1024[NextColorIndex];
                else
                    colorIndex = 0;
                return Colors_10[NextColorIndex];
            }
        ...
        static ColorRotator()
        {
            for (int i = 0; i < ColorValues_56.Length; i++)
            {
                Colors_56[i] = ColorTranslator.FromHtml(ColorValues_56[i]);
            }

            for (int i = 0; i < ColorValues_1024.Length; i++)
            {
                Colors_1024[i] = ColorTranslator.FromHtml(ColorValues_1024[i]);
            }
        }
        #endregion 构造函数 end
        ...
        /// 生成指定数量且不重复的颜色列表
        /// </summary>
        /// <param name="colorNum">指定数量，不能超过1024</param>
        /// <returns></returns>
        public static List<Color> GenerateColorList(int colorNum)
        {
            if (colorNum > 1024)
            {
                throw new ArgumentOutOfRangeException(nameof(colorNum), "指定数量不能超过1024");
            }
            List<Color> colorList = new List<Color>();
            Hashtable hashtable = new Hashtable();
            Random rm = new Random();

            for (int i = 0; hashtable.Count < colorNum; i++)
            {
                int nValue = rm.Next(0, 1023);
                ...
                else
                {
                    ...
                    if (nValue <= Colors_10.Length)
                    {
                        colorList.Add(Colors_10[nValue]);
                    }
                    else if (Colors_10.Length < nValue && nValue <= Colors_56.Length)
                    {
                        colorList.Add(Colors_56[nValue]);
                    }
                    else
                    {
                        colorList.Add(Colors_1024[nValue]);
                    }
                }
            }
            return colorList;
