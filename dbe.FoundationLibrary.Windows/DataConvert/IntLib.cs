...
{
    /// <summary>
    /// Int类型(32位有符号整数，范围-2E15 ~ 2E15-1)数据转换类
    /// </summary>
    ...
    public class IntLib
    {
        ...
        [Obsolete("该方法已弃用，byte[].ToInt()取代它")]
        public static int GetIntFromByteArray(byte[] value, int startIndex = 0, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，byte[].ToIntArray()取代它")]
        public static int[] GetIntArrayFromByteArray(byte[] value, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，string.ToIntArray()取代它")]
