...
namespace GNDView.Library.DataConvert
{
    ...
    public class BitLib
    {
        ...
        [Obsolete("该方法已弃用，用Byte.GetBit()取代它")]
        ...
        [Obsolete("该方法已弃用，用Byte[].GetBitFrom2Bytes()取代它")]
        ...
        [Obsolete("该方法已弃用，用Byte[].GetBitFromByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，用Byte[].GetBitFrom2BytesArray()取代它")]
        ...
        [Obsolete("该方法已弃用，用short.GetBit()取代它")]
        ...
        [Obsolete("该方法已弃用，用ushort.GetBit()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ToBitArray()取代它")]
        ...
        [Description("将字节数组转换成布尔数组")]
        public static Span<bool> GetBitArrayFromByteArray(Span<byte> value, int start, int length)
        {
            if (length <= 0) throw new ArgumentException("长度必须为正数");
            ...
            var bitArr = MemoryMarshal.Cast<byte, bool>(value);
            var result = new Span<bool>(new bool[length]);
            bitArr.Slice(start, length).CopyTo(result);
        ...
        [Obsolete("该方法已弃用，bool[].SubBitArray()取代它")]
        ...
        [Description("根据位开始和长度截取布尔数组")]
        public static Span<bool> GetBitSpanFromBitArray(Span<bool> value, int start, int length)
        {
            if (start < 0) throw new ArgumentException("开始索引不能为负数");
            ...
            //Span<bool> result = stackalloc bool[length];
            //var result = new Span<bool>(new bool[length]);
            //value.Slice(start, length).CopyTo(result);
            var result = value.Slice(start, length);
        ...
        [Obsolete("该方法已弃用，string.ToBitArray()取代它")]
        ...
        [Description("将字符串按照指定的分隔符转换成布尔数组")]
        public static Span<bool> GetBitArrayFromBitArrayString1(string value, string spilt = " ")
        {
            value = value.Trim();
            ...
            {// 字符串中不存在分隔符时，例如“101101101”
                var charSpan = value.ToArray().AsSpan();
                foreach (var item in charSpan)
                {
                    result.Add(IsBoolean(item));
                }
            }
        ...
        /// <returns>布尔结果</returns>
        [Description("判断是否为布尔")]
        [Obsolete("该方法已弃用，string.ToBoolean()取代它")]
        ...
        /// 判断字符是否为布尔✔
        /// </summary>
        /// <param name="value">布尔字符</param>
        /// <returns>布尔结果</returns>
        [Description("判断是否为布尔")]
        [Obsolete("该方法已弃用，char.ToBoolean()取代它")]
        public static bool IsBoolean(char value)
        {
            return value == '1';
        }
    }
