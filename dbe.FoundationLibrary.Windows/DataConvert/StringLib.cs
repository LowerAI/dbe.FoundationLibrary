...
namespace GNDView.Library.DataConvert
{
    ...
    public class StringLib
    {
        ...
        [Obsolete("该方法已弃用，byte[].ToStringByBitConvert()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ToStringByEncoding()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ToSiemensString()取代它")]
