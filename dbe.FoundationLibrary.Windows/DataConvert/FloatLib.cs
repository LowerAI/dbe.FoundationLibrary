...
{
    /// <summary>
    /// Float类型(32位单精度浮点数，范围-3.4x10E38 ~ +3.4x10E38)数据转换类
    /// </summary>
    ...
    public class FloatLib
    {
        ...
        [Obsolete("该方法已弃用，byte[].ToFloat()取代它")]
        public static float GetFloatFromByteArray(byte[] value, int startIndex = 0, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] b = ByteArrayLib.Get4BytesFromByteArray(value, startIndex, dataFormat);
        ...
        [Obsolete("该方法已弃用，byte[].ToFloatArray()取代它")]
        public static float[] GetFloatArrayFromByteArray(byte[] value, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，string.ToFloatArray()取代它")]
