...
{
    /// <summary>
    /// Long类型(64位有符号整数，范围-2E32 ~ 2E32-1)数据转换类
    /// </summary>
    ...
    public class LongLib
    {
        ...
        [Obsolete("该方法已弃用，byte[].ToLong()取代它")]
        public static long GetLongFromByteArray(byte[] value, int startIndex = 0, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，byte[].ToLongArray()取代它")]
        public static long[] GetLongArrayFromByteArray(byte[] value, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，string.ToLongArray()取代它")]
