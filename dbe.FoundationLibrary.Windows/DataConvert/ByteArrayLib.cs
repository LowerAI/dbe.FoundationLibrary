...
namespace GNDView.Library.DataConvert
{
    ...
    public class ByteArrayLib
    {
        ...
        [Obsolete("该方法已弃用，byte[].Subbytes()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].Sub2bytes()取代它")]
        public static byte[] Get2BytesFromByteArray(byte[] value, int start, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，byte[].Sub4bytes()取代它")]
        public static byte[] Get4BytesFromByteArray(byte[] value, int start, Endianness dataFormat = Endianness.ABCD)
        {
            List<byte> temp = new List<byte>();
            int diff = 4 - value.Length;
            if (diff > 0)
            {
            ...
            temp.AddRange(value);
            byte[] resTemp = GetByteArrayFromByteArray(temp.ToArray(), start, 4);
        ...
        [Obsolete("该方法已弃用，byte[].Sub8bytes()取代它")]
        public static byte[] Get8BytesFromByteArray(byte[] value, int start, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] res = new byte[8];
        ...
        [Obsolete("该方法已弃用，byte[].IsEquals()取代它")]
        ...
        [Obsolete("该方法已弃用，byte.ToByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，short.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromShort(short value, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，ushort.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromUShort(ushort value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，int.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromInt(int value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，uint.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromUInt(uint value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，float.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromFloat(float value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，double.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromDouble(double value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，long.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromLong(long value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，ulong.ToByteArray()取代它")]
        public static byte[] GetByteArrayFromULong(ulong value, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] resTemp = BitConverter.GetBytes(value);
        ...
        [Obsolete("该方法已弃用，short[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromShortArray(short[] value, Endianness dataFormat = Endianness.ABCD)
        {
        ...
        [Obsolete("该方法已弃用，ushort[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromUShortArray(ushort[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，int[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromIntArray(int[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，uint[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromUIntArray(uint[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，long[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromLongArray(long[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，ulong[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromULongArray(ulong[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，float[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromFloatArray(float[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，double[].ToByteArray()取代它")]
        public static byte[] GetByteArrayFromDoubleArray(double[] value, Endianness dataFormat = Endianness.ABCD)
        {
            ByteArray array = new ByteArray();
        ...
        [Obsolete("该方法已弃用，string.ToByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，string.ToByteArrayFromHexString()取代它")]
        ...
        [Obsolete("该方法已弃用，string.ToByteArrayFromHexStringWithoutSpilt()取代它")]
        ...
        [Obsolete("该方法已弃用，byte.ToByteArrayFromAsciiString()取代它")]
        ...
        [Obsolete("该方法已弃用，short.ToAsciiByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，ushort.ToAsciiByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，string.ToByteArrayFromAsciiString()取代它")]
        ...
        [Obsolete("该方法已弃用，bool[].ToByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，string.ToByteArrayFromSiemensString()取代它")]
        ...
        [Obsolete("该方法已弃用，string.ToByteArrayFromOmronCIPString()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ExtendAsEvenByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ToFixedLengthByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].ToAsciiByteArray()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].Union()取代它")]
        ...
        [Obsolete("该方法已弃用，byte[].SetByte()取代它")]
        ...
        [Description("常用值类型转换为字节数组")]
        public static byte[] ToByteArray<T>(T data, Endianness dataFormat = Endianness.ABCD)
        {
            byte[] buf;
            try
            {
                ...
                {
                    case char charValue:
                        buf = BitConverter.GetBytes(charValue);
                        break;
                    case bool boolValue:
                        buf = BitConverter.GetBytes(boolValue);
                        break;
                    case sbyte sbyteValue:
                        buf = new byte[] { (byte)sbyteValue };
                        break;
                    case byte byteValue:
                        buf = new byte[] { byteValue };
                        break;
                    case short shortValue:
                        buf = GetByteArrayFromShort(shortValue, dataFormat);
                        break;
                    case ushort ushortValue:
                        buf = GetByteArrayFromUShort(ushortValue, dataFormat);
                        break;
                    case int intValue:
                        buf = GetByteArrayFromInt(intValue, dataFormat);
                        break;
                    case uint uintValue:
                        buf = GetByteArrayFromUInt(uintValue, dataFormat);
                        break;
                    case long longValue:
                        buf = GetByteArrayFromLong(longValue, dataFormat);
                        break;
                    case ulong ulongValue:
                        buf = GetByteArrayFromULong(ulongValue, dataFormat);
                        break;
                    case float floatValue:
                        buf = GetByteArrayFromFloat(floatValue, dataFormat);
                        break;
                    case double doubleValue:
                        buf = GetByteArrayFromDouble(doubleValue, dataFormat);
                        break;
                    default:
        ...
        [Obsolete("该方法已弃用，byte[].ToValue()取代它")]
        public static T ToValue<T>(byte[] data, int index = 0, Endianness dataFormat = Endianness.ABCD)
        {
            ...
            try
            {
                ...
                {
                    case TypeCode.SByte:
                        val = SByteLib.GetByteFromByteArray(data, index);
                        break;
                    case TypeCode.Byte:
                        val = ByteLib.GetByteFromByteArray(data, index);
                        break;
                    case TypeCode.Boolean:
                        //string hexString = StringLib.GetHexStringFromByteArray(data);
                        //Debug.Print($"nFlag-hexString = {hexString}");
                        var nFlag = FloatLib.GetFloatFromByteArray(data, index, dataFormat);
                        //Debug.Print($"nFlag = {nFlag}");
                        val = Convert.ToBoolean(nFlag);
                        break;
                    case TypeCode.Char:
                        var chars = Encoding.Default.GetChars(data);
                        val = chars?[0];
                        break;
                    case TypeCode.String:
                        val = Encoding.Default.GetString(data);
                        break;
                    case TypeCode.UInt16:
                        val = UShortLib.GetUShortFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.Int16:
                        val = ShortLib.GetShortFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.UInt32:
                        val = UIntLib.GetUIntFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.Int32:
                        val = IntLib.GetIntFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.UInt64:
                        val = ULongLib.GetULongFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.Int64:
                        val = LongLib.GetLongFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.Single:
                        val = FloatLib.GetFloatFromByteArray(data, index, dataFormat);
                        break;
                    case TypeCode.Double:
                        val = DoubleLib.GetDoubleFromByteArray(data, index, dataFormat);
                        break;
                    default:
